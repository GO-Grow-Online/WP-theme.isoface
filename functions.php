<?php
/**
 * Julien's theme - based on Timber starter theme
...
// Give Editor Menu edition acces
...
// Image formats
add_image_size( 'card-thumbnail', 600, null, false );
add_image_size( 'gal-showcase', 400, 400, true );
...
function my_theme_scripts() {
	...
	wp_enqueue_script( 'script', get_template_directory_uri() . '/js/app.js', array( 'jquery' ), null, true );
}
...
class StarterSite extends Timber\Site {
	...
	public function add_to_context( $context ) {
		...
		$context['products_link'] = get_post_type_archive_link('produits');
		$context['projects_link'] = get_post_type_archive_link('projets');
		$context['news_link'] = get_post_type_archive_link('post');

		// Footer stuff
		$context['news_link'] = get_post_type_archive_link('post');

		$footer_pt = get_field('f_post_type', 'option');
		$footer_pt = $footer_pt['links'];
